...
colors = {
    'red': (255,0,0,128),
    'orange': (255,127,0,128),
    'yellow': (255,255,0,128),
    'green': (0,255,0,128),
    'blue': (0,0,255,128),
    'indigo': (75,0,130,128),
    'violet': (143,0,255,128),
...
def get_board(num_pixels=50, auto_write=False, brightness=0.5, pixel_order=neopixel.GRBW):
    ...
    return neopixel.NeoPixel(board.D18, num_pixels, bpp=3, auto_write=auto_write, brightness=brightness, pixel_order=pixel_order)
